...
VCF_SPLIT_JOB=$JOBDIR/$VCF_SPLIT_JOBNAME.sh
...
FUSION_READ_EXTRACTION_JOB=$JOBDIR/$FUSION_READ_EXTRACTION_JOBNAME.sh
...
CONSENSUS_MAPPING_JOB=$JOBDIR/$CONSENSUS_MAPPING_JOBNAME.sh
...
MERGE_BAMS_JOB=$JOBDIR/$MERGE_BAMS_JOBNAME.sh
...
SV_CALLING_JOB=$JOBDIR/$SV_CALLING_JOBNAME.sh
...
FUSION_CHECK_JOB=$JOBDIR/$FUSION_CHECK_JOBNAME.sh
