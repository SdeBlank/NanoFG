...
SPLIT_VCF_JOBNAME=${VCF/.vcf/_split_vcf}
...
NANOFG_JOBNAME=${VCF/.vcf/_NanoFG}
...
MERGE_OUTPUT_JOBNAME=${VCF/.vcf/_merge_output}
MERGE_OUTPUT_JOB=$JOBDIR/$MERGE_OUTPUT_JOBNAME.sh
MERGE_OUTPUT_ERR=$LOGDIR/$MERGE_OUTPUT_JOBNAME.log
MERGE_OUTPUT_LOG=$LOGDIR/$MERGE_OUTPUT_JOBNAME.err
